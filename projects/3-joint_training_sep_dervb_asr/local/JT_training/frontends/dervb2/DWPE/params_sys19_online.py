gpu_id = '1'
task = 'DNN-WPE-Online'  # DNN-WPE-Offline,  DNN-WPE-Online for parameters setting
# =========================================
est_power = False
scratch = False
...
if not scratch:
    model_path = '/users/bdda/gnli/projects/bdda8_projects/TASLP-22/Front-End/dereverberation/DNN-WPE-CM/summary_sys19_dervb_add_visual-False/model_dnn-wpe_pf-1e-10_scale_by_mixture-False_hop_size-128/b64-best-19.pt.tar'
...
sum_dir = f'./summary_sys19_dervb_add_visual-{add_visual}-online'
