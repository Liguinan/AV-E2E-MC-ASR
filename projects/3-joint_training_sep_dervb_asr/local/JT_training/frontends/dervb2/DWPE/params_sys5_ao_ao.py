...
model_offline = f'model_dnn-wpe-delay-{delay}_pf-1e-10_scale_by_mixture-False_hop_size-128'
...
wav_dir_name = f"{inference_dataset_name}_eps={ckpt_epoch}_dl={diag_loading_ratio}_taps={taps}_norm={normalization}"
ckpt = f'b{batch_size}-best-{ckpt_epoch}.pt.tar'
# ================= Directory ===================== #
data_dir = '/project_bdda7/bdda/gnli/Data/lrs2_new/pkl_data'
sum_dir = f'./summary_sys5_sep_ao+dervb_add_visual-{add_visual}'
# sum_dir = f'./summary_sys6_sep_ao+dervb_add_visual-{add_visual}'
# sum_dir = f'./summary_sys7_sep_vo+dervb_add_visual-{add_visual}'
# sum_dir = f'./summary_sys9_sep_av+dervb_add_visual-{add_visual}'
