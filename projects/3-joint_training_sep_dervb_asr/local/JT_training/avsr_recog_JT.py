...
def get_parser():
    ...
    parser.add_argument(
     ...
     ######## customized wav saved ############
    parser.add_argument(
        "--write-wav",
        type=strtobool,
        default=True,
        help="The flag to use visual in asr.",
    )
    parser.add_argument(
        "--write-wav-dir", type=str, required=True, help="Output wav directory"
    )
    parser.add_argument(
        "--sampling-rate",
        default=16000,
        type=int,
        help="wav sampling rate",
    )
    return parser
...
def main(args):
    ...
    # import os
    # ### infer wav dir created #### 
    # if args.write_wav:
    #     if not os.path.exists(args.write_wav_dir):
    #         os.makedirs(args.write_wav_dir)
        ...
        if args.backend == "chainer":
            ...
            if args.num_encs == 1:
                ...
                if args.api == "v2":
                    ...
                    from espnet.JT_training.asr import recog
