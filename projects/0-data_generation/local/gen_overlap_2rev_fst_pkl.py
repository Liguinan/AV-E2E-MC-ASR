...
def main(argv):
    ...
    # num fst
    num_fst_scp_dct = {}
    with open(num_fst_scp, "r", encoding='utf-8') as fr:
        lines = fr.readlines()
        for line in lines:
            num_fst_scp_dct[line.split()[0]] = line.split()[1].strip()
    ...
    for spk_utter_id, emb in lrs2_lip_emb_dct.items():
        ...
        num_fst = num_fst_scp_dct[spk_utter_id]
    ...
    save_dict(data, output_dir + "/" + dataset + "_overlap_fst" )
