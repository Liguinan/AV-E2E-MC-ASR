...
# model_save_dir = sum_dir + f'/model_tfmasking-AF_premasking={AF_premasking}/'
# model_save_dir = sum_dir + f'/model_tfmasking/'
# model_save_dir = sum_dir + f'/model_tfmasking-AF_premasking={AF_premasking}-Batch_Size={batch_size}/'
