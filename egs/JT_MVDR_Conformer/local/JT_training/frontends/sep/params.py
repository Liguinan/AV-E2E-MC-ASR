...
# if AF_premasking:
#     if resume:
#         training_model_subpath="model_mvdr-AF_premasking=True/uTGT-LPS_IPD_AF-b12-BN-fd1-fixTrue-f0-cosTrue-sinFalse-last-53.pt.tar"
#     else:
#         # training_model_subpath="uTGT-LPS_IPD_AF-b32-BN-fd1-fixTrue-f0-cosTrue-sinFalse-best-48.pt.tar"
#         training_model_subpath="model_tfmasking-AF_premasking=True-Batch_Size=64/uTGT-LPS_IPD_AF-b64-BN-fd1-fixTrue-f0-cosTrue-sinFalse-best-55.pt.tar"
# else:
#     if resume:
#         training_model_subpath="model_mvdr-AF_premasking=True/uTGT-LPS_IPD_AF-b12-BN-fd1-fixTrue-f0-cosTrue-sinFalse-last-55.pt.tar"
#     else:
...
# model_save_dir = sum_dir + f'/model_mvdr-AF_premasking={AF_premasking}-Batch_Size={batch_size}-Dloading={diag_loading_ratio}-hop{HOP_SIZE}/'
# model_save_dir = sum_dir + f'/model_mvdr-AF_premasking={AF_premasking}-Batch_Size={batch_size}-Dloading={diag_loading_ratio}-hop{HOP_SIZE}-debug/'
